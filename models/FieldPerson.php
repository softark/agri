...
/**
 * This is the model class for table "field_person".
 *
 * @property int $id
 * @property int $role
...
class FieldPerson extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['note'], 'default', 'value' => ''],
            [['role', 'field_id', 'person_id', 'created_by', 'updated_by'], 'default', 'value' => null],
    ...
    {
        $latest = FieldPerson::find()
            ->where(['field_id' => $this->field_id, 'role' => $this->role, 'valid_to' => null])
            ->one();
